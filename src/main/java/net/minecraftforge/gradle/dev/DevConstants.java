...
final class DevConstants
{
    ...
    static final String INSTALLER_URL       = "https://teamopenindustry.cc/maven/net/minecraftforge/installer/{INSTALLER_VERSION}/installer-{INSTALLER_VERSION}-shrunk.jar";
